...
(function () {
    ...
    proto.create = function (id, params) {
        ...
        this.listController = new OTW.ui.controller.ListController();
        this.listController.create();
        this.div.append(this.listController.getView());
    };
    ...
    proto.handleKeyEvent = function (keyCode) {
        ...
        if (this.listController.getFocus()) {
            this.listController.handleKeyEvent(keyCode);
        }
    };
})();